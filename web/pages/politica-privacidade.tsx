    ...
    <Layout>
      <div className="container mx-auto flex flex-col gap-8 px-8 lg:px-0">
        <div className="flex flex-col gap-2">
          <SectionTitle as="h1">
            Política de Privacidade do Cefa Instagram App Facebook aplicativo
          </SectionTitle>
          <p>
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="font-bold">Centro Espírita Francisco de Assis</p>
          <p>
            E-mail de contato do Proprietário:{' '}
            <span className="font-bold">admin@cefa.com.br</span>
          </p>
        </div>
        <hr />
        <div className="flex flex-col gap-2">
          <SectionTitle as="h2">Tipos de Dados coletados</SectionTitle>
        ...
        <p>
          ...
          textos explicativos específicos exibidos antes da coleta de Dados. Os
          Dados Pessoais poderão ser fornecidos livremente pelo Usuário, ou, no
        ...
        <p>
          ...
          este Aplicativo são obrigatórios e a falta de fornecimento destes
          Dados poderá impossibilitar este Aplicativo de fornecer os seus
          Serviços. Nos casos em que este Aplicativo afirmar especificamente que
          alguns Dados não forem obrigatórios, os Usuários ficam livres para
          deixarem de comunicar estes Dados sem nenhuma consequência para a
        ...
        <p>
          ...
          deste Serviço (este Aplicativo) e confirmam que possuem a autorização
          dos terceiros para fornecerem os Dados para o Proprietário.
        </p>
        <hr />
        <div className="flex flex-col gap-2">
          <SectionTitle as="h2">
        ...
        <p>
          ...
          (este Aplicativo) (administração, vendas, marketing, administração
          legal do sistema) ou pessoas externas (como fornecedores terceirizados
          de serviços técnicos, carteiros, provedores de hospedagem, empresas de
          ...
          destas partes pode ser solicitada ao Proprietário a qualquer momento.
        </p>
        <SectionTitle as="h3" size="small">
        ...
        <p>
          o processamento estiver relacionado a uma tarefa que for executada no
          interesse público ou no exercício de uma autorização oficial na qual o
          Proprietário estiver investido;
        </p>
        <p>
        ...
        <p>
          ...
          que não seja o seu. Para descobrirem mais sobre o local de
          processamento de tais Dados transferidos os Usuários poderão verificar
          a seção contendo os detalhes sobre o processamento de Dados Pessoais.
        </p>
        <p>
        ...
        <p>
          Este Aplicativo pode pedir algumas permissões no Facebook que permitem
          realizar ações com a conta do usuário no Facebook e para recuperar as
          informações, incluindo dados pessoais. Este serviço permite que este
          Aplicativo se conecte com a conta do Usuário na rede social Facebook,
          fornecido pelo Facebook Inc.
        </p>
        <p>
          Para mais informações sobre as seguintes permissões, consulte a
          documentação de permissões Facebook e a política de privacidade do
          Facebook.
        </p>
        <p>As permissões solicitadas são as seguintes: Informações básicas.</p>
        <hr />
        <div className="flex flex-col gap-2">
          <SectionTitle as="h2">Os direitos dos Usuários</SectionTitle>
          <p>
        ...
        <p>
          Objetar o processamento dos seus Dados. Os Usuários possuem o direito
          de objetar o processamento dos seus Dados se o processamento for
          executado sobre outra base jurídica que não a anuência. São fornecidos
          detalhes adicionais na seção específica abaixo.
        </p>
        <p>
        ...
        <p>
          ...
          direito de restringir o processamento dos seus Dados para qualquer
          outra finalidade que não seja o armazenamento dos mesmos.
        </p>
        <p>
          Ter os seus Dados Pessoais apagados ou retirados de outra maneira. Os
          Usuários possuem o direito de obter a eliminação dos seus Dados do
          Proprietário.
        </p>
        <p>
          ...
          máquinas e, se for viável tecnicamente, fazer com que estes sejam
          transmitidos para outro controlador sem nenhum empecilho.
        </p>
        <p>
          Registrar uma reclamação. Os Usuários possuem o direito de apresentar
          reclamação perante a sua autoridade de proteção de dados competente.
        </p>
        <SectionTitle as="h3" size="small">
        ...
        <p>
          ...
          objetar tal processamento a qualquer momento de forma gratuita e sem
          fornecer qualquer justificativa. Quando o Usuário se opuser ao
          processamento para fins de marketing direto, os Dados Pessoais não
          serão mais processados para esses fins. Para saber se o Proprietário
          está processando Dados Pessoais para fins de marketing direto, os
          Usuários podem consultar as seções respectivas deste documento.
        </p>
        <SectionTitle as="h3" size="small">
        ...
        <p>
          ...
          todos os casos, em prazo inferior a um mês, fornecendo aos Usuários as
          informações exigidas por lei. Qualquer retificação ou exclusão de
          Dados Pessoais ou restrição de processamento será comunicada pelo
          Proprietário a cada destinatário, se houver, a quem os Dados Pessoais
          foram divulgados, a menos que isso seja impossível ou implique um
          trabalho desproporcional. A pedido dos Usuários, o Proprietário os
          informará sobre tais destinatários.
        </p>
        <hr />
        <SectionTitle as="h2">
          Os direitos dos UsuáriosInformações adicionais sobre a coleta e
        ...
        <p>
          ...
          Aplicativo) ou dos Serviços relacionados.
        </p>
        <p>
          O Usuário declara estar ciente de que o Proprietário poderá ser
          obrigado a revelar os Dados Pessoais mediante solicitação das
        ...
        <hr />
        <SectionTitle as="h2">Definições e referências jurídicas</SectionTitle>
        <SectionTitle as="h3" size="small">
        ...
        <p>
          ...
          Aplicativo)), que podem incluir: os endereços IP ou nomes de domínio
          dos computadores utilizados pelos Usuários que utilizam este
          Aplicativo, os endereços URI (Identificador Uniforme de Recurso), a
          data e hora do pedido, o método utilizado para submeter o pedido ao
          servidor, o tamanho do arquivo recebido em resposta, o código numérico
          que indica o status do servidor de resposta (resultado positivo, erro
          , etc.), o país de origem, as características do navegador e do
          sistema operacional utilizado pelo Usuário, os vários detalhes de
        ...
        <hr />
        <SectionTitle as="h2">Informação jurídica</SectionTitle>
        <p>
          Esta declaração de privacidade foi preparada com base em determinações
          de múltiplas legislações, inclusive os Arts. 13/14 do Regulamento (EU)
